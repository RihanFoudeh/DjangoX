...
class SnackTest(TestCase):
    ...
    def test_snack_create_view(self):
        expected = 200
        actual = self.client.post(reverse('snack_create'),{'title': 'pizza', ' purshaser': self.user,'description': 'Flat bread with meat',})
    ...
    def test_snack_update_view(self):
        expected = 200
        actual = self.client.post(reverse('snack_update', args='1')).status_code
    ...
    def test_snack_delete_view(self):
        expected = 200
        actual = self.client.get(reverse('snack_delete', args='1')).status_code
        self.assertEqual(expected, actual)
